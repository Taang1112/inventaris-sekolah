        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="nip-text">{{ $item->nip }}</span>
                    </td>
                    <td>
                    ...
                    <td style="text-align: right;">
                        <div class="action-btns">
                            ...
                            <form action="{{ route('guru.destroy', $item->guru_id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data guru ini?')" style="display: inline;">
                                @csrf
                                @method('DELETE')
