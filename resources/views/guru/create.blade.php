...
@section('content')
    <div class="form-container">
        ...
        <div class="info-card">
            ...
            <p>Isi formulir berikut dengan lengkap untuk menambahkan guru baru ke dalam sistem. Pastikan NIP bersifat unik.</p>
        </div>
        ...
        <form action="{{ route('guru.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Nomor Induk Pegawai, harus unik
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Nomor telepon aktif
                </div>
            </div>
