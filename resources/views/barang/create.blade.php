...
@section('content')
    <div class="form-container">
        ...
        <div class="info-card">
            ...
            <p>Isi formulir berikut dengan lengkap untuk menambahkan barang baru ke dalam sistem. Pastikan kode barang bersifat unik.</p>
        </div>
        ...
        <form action="{{ route('barang.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Gunakan format yang konsisten, misal: BRG001, BRG002
                </div>
            </div>
            ...
            <div class="form-group">
                <label>Jumlah Total <span style="color: #ef4444;">*</span></label>
                <div class="input-wrapper">
            ...
            <div class="form-group">
                <label>Jumlah Tersedia <span style="color: #ef4444;">*</span></label>
                <div class="input-wrapper">
                ...
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Jumlah tersedia tidak boleh melebihi jumlah total
                </div>
            </div>
