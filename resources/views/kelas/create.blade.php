...
@section('content')
    <div class="form-container">
        ...
        <div class="info-card">
            ...
            <p>Isi formulir berikut untuk menambahkan kelas baru. Pilih wali kelas dari daftar guru yang tersedia.</p>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="nama_kelas" value="{{ old('nama_kelas') }}" 
                           placeholder="Contoh: X IPA 1, XI IPS 2, XII MIPA 3" required>
                </div>
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Gunakan format yang konsisten
                </div>
            </div>

            <div class="form-group">
                <label>Wali Kelas <span style="color: #ef4444;">*</span></label>
                <div class="input-wrapper">
                ...
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Pilih guru yang akan menjadi wali kelas
                </div>
            </div>
